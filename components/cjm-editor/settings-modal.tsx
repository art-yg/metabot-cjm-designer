...
function SettingsModal({ isOpen, onClose, settings, onSave }: SettingsModalProps) {
  ...
  const handleFieldChange = (field: keyof MapSettings, value: string | number) => {
        ...
        <div className="space-y-6 py-4">
          ...
          <div className="grid gap-4">
            <div className="space-y-2">
              ...
              />
              <p className="text-xs text-gray-500">ID бота в системе MetaBot, в рамках которого будет создана карта</p>
            </div>
          ...
          <div className="p-3 bg-blue-50 border border-blue-200 rounded-md">
            <p className="text-sm text-blue-700">
              <strong>Примечание:</strong> Эти настройки будут использованы при экспорте схемы в MetaBot. Убедитесь, что
