...
function Palette({
  ...
  return (
    <div className="w-60 bg-gray-100 p-4 border-r border-gray-200 flex flex-col h-full">
      <h2 className="text-lg font-semibold text-gray-700 mb-2 flex-shrink-0">Палитра компонентов</h2>
      ...
      <div className="flex-1 overflow-y-auto custom-scrollbar space-y-3 pr-2 -mr-2">
        ...
        <div className="space-y-2">
          <h3 className="text-sm font-medium text-gray-600 border-b pb-1">Команды ввода</h3>
          <button
          ...
          >
            <KeyboardIcon size={18} className="mr-2" />
            Ввод пользователя
          </button>
          <button
        ...
        <div className="space-y-2">
          <h3 className="text-sm font-medium text-gray-600 border-b pb-1">Искусственный интеллект</h3>
          <button
        ...
        <div className="space-y-2">
          <h3 className="text-sm font-medium text-gray-600 border-b pb-1">Аналитика и теги</h3>
          <button
        ...
        <div className="space-y-2">
          <h3 className="text-sm font-medium text-gray-600 border-b pb-1">Переходы и точки входа</h3>
          <button
