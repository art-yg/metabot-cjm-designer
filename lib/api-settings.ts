export interface ApiSettings {
  ...
  client_id: string
  client_key: string
  prompts_table: string
  knowledge_base_table: string
}

export const DEFAULT_API_SETTINGS: ApiSettings = {
  endpoint: "https://stage.metabot.dev/api/v1/bots/{bot_id}/call/",
  bearerToken:
    "eyJ0eXAiOiJKV1QiLCJhbGciOiJSUzI1NiJ9..S5a4dL8HNZw9GpaDZENMFy9ZDIZEJz0m2c4CxuITFAQABz23C7WJzyh00GrHXKLb_zaOVIcOw7nSaBivKMl0nDVX-60UqfkfejkXFabZLiDyIjTbLT8-1hKuk2rOTC0sI8aypOJ76oEAWRI7wvpTLk3bs0640fLIa2Msw9jjvkwO3Db_yjvdZCOk-grD06bFnEqR7tEGYHvLri0ddmpsre16sICEeBwhhByKAMNeiFSG8bNjk5ARHx50kYy8XHbnnQHK5-G2yAAyhIHcoMo_D1wTsiELny00QlI0Vi5sndj1r_HJroJXruz8WwfhHWhUq331MLuFInkIokA1NitVmu4oA1rVTuCUKChrQReKgS6Gt08aeyvhOcNY8P8Jwvx78OpSvNmXAobxj-Q0A2oxgnT0DoVkfrBBRrtRiC7Epz4E2CEeAourwA8TdvvqLx9erSnr-uZl9_LKLYiIS_zZwQLrcL5eZNtIQKof1l-dFf9yeo-6xu-3xyLR35SsgA3Tnu_mq5TIjLLltP4HXhaUOlrKdXImCe5aaZ5tjdJW6iO7GbEYY2VWv21Vm8PWopcUyhA_-mHDN6MDUfbJbJjE0yiN1dWbb-iaeY7UbTuuZoXZi5PSUbRTxwkEwrZB75vcNkPKg8XqlQn6QyAWQ7sLX6tpHgmLRAwHCPswBK-mL2k",
  format: "CJM",
  version: "1.0",
  client_id: "",
  client_key: "",
  prompts_table: "gpt_prompts",
  knowledge_base_table: "gpt_kb",
}
  ...
  try {
    ...
    if (saved) {
      ...
      return {
        ...
        client_id: parsed.client_id || DEFAULT_API_SETTINGS.client_id,
        client_key: parsed.client_key || DEFAULT_API_SETTINGS.client_key,
        prompts_table: parsed.prompts_table || DEFAULT_API_SETTINGS.prompts_table,
        knowledge_base_table: parsed.knowledge_base_table || DEFAULT_API_SETTINGS.knowledge_base_table,
      }
    }
  } catch (error) {
...
export function validateApiSettings(settings: ApiSettings): { isValid: boolean; errors: string[] } {
  ...
  if (!settings.client_id || settings.client_id.trim() === "") {
    errors.push("Client ID обязателен для работы с MetaTables")
  }

  if (!settings.client_key || settings.client_key.trim() === "") {
    errors.push("Client Key обязателен для работы с MetaTables")
  }

  if (!settings.prompts_table || settings.prompts_table.trim() === "") {
    errors.push("Название таблицы промптов обязательно")
  }

  if (!settings.knowledge_base_table || settings.knowledge_base_table.trim() === "") {
    errors.push("Название таблицы базы знаний обязательно")
  }
